...
<div id="kbihuImportModal" style="position: fixed; inset: 0; background: rgba(15, 23, 42, 0.45); display: none; align-items: center; justify-content: center; padding: 16px; z-index: 60;">
    <div style="background: white; width: 100%; max-width: 520px; border-radius: 14px; padding: 20px; box-shadow: 0 20px 50px rgba(15, 23, 42, 0.2);">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 16px;">
            <h3 style="margin: 0; font-size: 18px; font-weight: 700; color: #111827;">Import Data KBIHU</h3>
            <button type="button" id="kbihuImportClose" style="border: none; background: transparent; font-size: 20px; cursor: pointer; color: #6b7280;">&times;</button>
        </div>
        ...
        <form action="{{ route('admin.data-informasi.kbihu.import') }}" method="POST" enctype="multipart/form-data">
            ...
            <div style="margin-top: 8px; font-size: 12px; color: #9ca3af;">
                Kolom yang dibaca: Nama KBIHU, Alamat, Tahun Berdiri, Nama Pimpinan, No Telp, Latitude, Longitude, Link Maps.
            </div>
            <div style="display: flex; justify-content: flex-end; gap: 10px; margin-top: 18px;">
                <button type="button" id="kbihuImportCancel"

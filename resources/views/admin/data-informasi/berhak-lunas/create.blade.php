...
<div class="card">
    ...
    <form action="{{ route('admin.data-informasi.berhak-lunas.store') }}" method="POST">
        ...
        <div style="margin-bottom: 24px;">
            ...
            <input type="text" name="nomor_porsi" value="{{ old('nomor_porsi') }}" required minlength="10" maxlength="10" pattern="\d{10}"
        ...
        <div style="margin-bottom: 24px;">
            ...
            <input type="text" name="nomor_paspor" value="{{ old('nomor_paspor') }}" minlength="8" maxlength="8" pattern="[A-Za-z0-9]{8}"
                   style="width: 100%; padding: 12px; border: 1px solid #d1d5db; border-radius: 8px; font-size: 14px;"

    ...
    <form action="{{ route('admin.data-informasi.berhak-lunas.store') }}" method="POST">
        ...
        <div style="margin-bottom: 24px;">
            ...
            <select name="status" required
                ...
                <option value="Berhak Lunas" {{ old('status') == 'Berhak Lunas' ? 'selected' : '' }}>Berhak Lunas</option>
                <option value="Menunggu" {{ old('status') == 'Menunggu' ? 'selected' : '' }}>Menunggu</option>
                <option value="Tidak Berhak" {{ old('status') == 'Tidak Berhak' ? 'selected' : '' }}>Tidak Berhak</option>
            </select>
        </div>

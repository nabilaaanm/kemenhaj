...
@section('title', 'Tambah PPIU')
@section('page-title', 'Tambah PPIU')
...
<div class="card">
    ...
    <h3 style="margin-bottom: 24px;">Tambah Data PPIU</h3>
    ...
    <form action="{{ route('admin.data-informasi.ppiu.store') }}" method="POST">
        @csrf
        ...
        <div style="margin-bottom: 24px;">
            ...
            <input type="text" name="direktur" value="{{ old('direktur') }}"
                   style="width: 100%; padding: 12px; border: 1px solid #d1d5db; border-radius: 8px; font-size: 14px;"
        ...
        <div style="margin-bottom: 24px;">
            ...
            <input type="text" name="terakreditasi" value="{{ old('terakreditasi') }}"
                   style="width: 100%; padding: 12px; border: 1px solid #d1d5db; border-radius: 8px; font-size: 14px;"
                   placeholder="A / B / C">
        </div>

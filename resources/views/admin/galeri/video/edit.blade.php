...
<div class="card">
    ...
    <h3 style="margin-bottom: 24px;">Edit Video Galeri</h3>
    ...
    <form action="{{ route('admin.galeri.video.update', $video->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
            ...
            <select name="category"
                ...
                @else
                    @foreach($categories as $category)
                        <option value="{{ $category->name }}" {{ old('category', $video->category) == $category->name ? 'selected' : '' }}>
                            {{ $category->name }}
                        </option>
                    @endforeach
                @endif
        ...
        <div style="margin-bottom: 24px;">
            <label style="display: block; font-weight: 600; margin-bottom: 8px; color: #374151;">Upload File Video (Opsional)</label>
        ...
        <div style="margin-bottom: 24px;">
            <label style="display: block; font-weight: 600; margin-bottom: 8px; color: #374151;">Thumbnail Video (Opsional)</label>
        ...
        <div style="margin-bottom: 24px;">
            <label style="display: block; font-weight: 600; margin-bottom: 8px; color: #374151;">Masukkan URL Video (Opsional)</label>
            <p style="color: #6b7280; font-size: 14px; margin-bottom: 8px;">Masukkan link video dari YouTube, Vimeo, atau platform lainnya.</p>

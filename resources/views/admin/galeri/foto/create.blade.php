...
<div class="card">
    <div style="margin-bottom: 24px;">
        <a href="{{ route('admin.galeri.foto.index') }}" style="display: inline-flex; align-items: center; color: #6b7280; text-decoration: none; margin-bottom: 16px;">
    ...
    <h3 style="margin-bottom: 24px;">Tambah Foto ke Galeri</h3>
    ...
    <form action="{{ route('admin.galeri.foto.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div style="margin-bottom: 24px;">
            <label style="display: block; font-weight: 600; margin-bottom: 8px; color: #374151;">Judul Foto <span style="color: #ef4444;">*</span></label>
        ...
        <div style="margin-bottom: 24px;">
            <label style="display: block; font-weight: 600; margin-bottom: 8px; color: #374151;">Upload File Foto</label>
        ...
        <div style="margin-bottom: 24px;">
            <label style="display: block; font-weight: 600; margin-bottom: 8px; color: #374151;">Masukkan URL Gambar</label>
            ...
            <div id="urlPreview" style="margin-top: 16px; display: none;">
                <img id="urlPreviewImg" src="" alt="Preview" style="max-width: 100%; max-height: 300px; border-radius: 8px; border: 1px solid #d1d5db;"

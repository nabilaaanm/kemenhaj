...
<div class="card">
    ...
    <h3 style="margin-bottom: 24px;">Tambah Regulasi Baru</h3>
    ...
    <form action="{{ route('admin.regulasi.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div style="margin-bottom: 24px;">
            ...
            <textarea name="description" rows="4"
                      ...
                      placeholder="Deskripsi regulasi (opsional)">{{ old('description') }}</textarea>
        </div>
        ...
        <div style="margin-bottom: 24px;">
            ...
            <input type="date" name="regulation_date" value="{{ old('regulation_date') }}" required
                   style="width: 100%; padding: 12px; border: 1px solid #d1d5db; border-radius: 8px; font-size: 14px;">
        </div>

        <div style="margin-bottom: 24px;">
            <label style="display: block; font-weight: 600; margin-bottom: 8px; color: #374151;">File PDF</label>
            <p style="color: #6b7280; font-size: 14px; margin-bottom: 8px;">Format: PDF (Maksimal 10MB)</p>

    ...
    <form method="POST" action="{{ route('admin.pengaturan.slideshow.update', $slide->title) }}" enctype="multipart/form-data">
        ...
        <div style="display: grid; grid-template-columns: 1fr; gap: 16px; margin-bottom: 24px;">
            <div>
                ...
                <input type="number" name="order" value="{{ old('order', $slide->order) }}" min="1"
        ...
        <div style="margin-bottom: 24px;">
            ...
            <textarea name="description" rows="4"
                      style="width: 100%; padding: 12px; border: 1px solid #d1d5db; border-radius: 8px; font-size: 14px; font-family: inherit; resize: vertical;">{{ old('description', $slide->description) }}</textarea>
        </div>
        ...
        <div style="margin-bottom: 24px;">
            ...
            <div style="margin-bottom: 12px;">
                <img src="{{ $slide->image_url }}" alt="{{ $slide->title }}" style="width: 220px; height: 120px; object-fit: cover; border-radius: 8px; border: 1px solid #e5e7eb;">
            </div>

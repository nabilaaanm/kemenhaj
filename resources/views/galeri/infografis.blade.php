...
<main class="container-fixed py-12 w-full" style="width: 100%; max-width: 100%; box-sizing: border-box;">
    ...
    <div class="mb-12 text-center">
        <h1 class="text-4xl md:text-5xl font-bold mb-4" style="color: #374151;" data-i18n="gallery.infographics.title">
            Galeri Infografis
        </h1>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const translations = {
            id: {
                ...
                'gallery.infographics.title': 'Galeri Infografis',
                'gallery.infographics.subtitle': 'Informasi visual tentang haji, umrah, dan pelayanan Kementerian Haji dan Umrah Kota Cirebon',
                'gallery.filter.all': 'Semua',
                'gallery.filter.hajj': 'Haji',
                'gallery.filter.umrah': 'Umrah',
                'gallery.filter.info': 'Informasi',
                'gallery.infographics.item1': 'Panduan Ibadah Haji',
                'gallery.infographics.item2': 'Panduan Ibadah Umrah',
                'gallery.infographics.item3': 'Alur Pendaftaran Haji',
                'gallery.infographics.item4': 'Persiapan Sebelum Haji',
                'gallery.infographics.item5': 'Tips Umrah',
                'gallery.infographics.item6': 'Statistik Haji 2024',
                'gallery.infographics.item7': 'Rukun dan Wajib Haji',
                'gallery.infographics.item8': 'Rukun Umrah',
                'gallery.infographics.item9': 'Layanan Kemenhaj',
            ...
            en: {
                ...
                'footer.platform': 'Platform',
                // Gallery Infographics
                'gallery.infographics.title': 'Infographic Gallery',
                'gallery.infographics.subtitle': 'Visual information about Hajj, Umrah, and services of the Ministry of Hajj and Umrah of Cirebon City',
                'gallery.filter.all': 'All',
                'gallery.filter.hajj': 'Hajj',
                'gallery.filter.umrah': 'Umrah',
                'gallery.filter.info': 'Information',
                'gallery.infographics.item1': 'Hajj Worship Guide',
                'gallery.infographics.item2': 'Umrah Worship Guide',
                'gallery.infographics.item3': 'Hajj Registration Flow',
                'gallery.infographics.item4': 'Pre-Hajj Preparation',
                'gallery.infographics.item5': 'Umrah Tips',
                'gallery.infographics.item6': 'Hajj Statistics 2024',
                'gallery.infographics.item7': 'Hajj Pillars and Obligations',
                'gallery.infographics.item8': 'Umrah Pillars',
                'gallery.infographics.item9': 'Kemenhaj Services',
        ...
        const prevInfographic = document.getElementById('prevInfographic');
        const nextInfographic = document.getElementById('nextInfographic');
        let currentInfographicIndex = 0;
        const allInfographics = Array.from(infographicItems);
        
        // Open modal on infographic click
        infographicItems.forEach((item, index) => {
            item.addEventListener('click', function() {
                currentInfographicIndex = index;
        ...
        function showInfographic(index) {
            if (index < 0) index = allInfographics.length - 1;
            if (index >= allInfographics.length) index = 0;
            currentInfographicIndex = index;
            const img = allInfographics[index].querySelector('img');
            modalImage.src = img.src;
        }
        
        prevInfographic.addEventListener('click', function(e) {
            e.stopPropagation();
            showInfographic(currentInfographicIndex - 1);
        });
        
        nextInfographic.addEventListener('click', function(e) {
            e.stopPropagation();
            showInfographic(currentInfographicIndex + 1);
        });

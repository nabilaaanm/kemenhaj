...
<head>
    ...
    <title>Berita - Kementerian Haji dan Umrah Kota Cirebon</title>
...
<main class="container-fixed py-12 w-full" style="width: 100%; max-width: 100%; box-sizing: border-box;">
    ...
    <div class="text-center mb-8">
        <h1 class="text-4xl md:text-5xl font-bold mb-4" style="color: #8B6914;" data-i18n="berita.title">
            Berita
        </h1>
        <p class="text-lg text-gray-600 max-w-3xl mx-auto" data-i18n="berita.subtitle">
            Berita Terkini
        </p>
    </div>
    ...
    <div class="mb-8">
        <div class="flex flex-col md:flex-row gap-4 items-center justify-center max-w-3xl mx-auto">
            <div class="flex-1 w-full relative">
                <input type="text" id="beritaSearch" data-i18n-placeholder="berita.searchPlaceholder" placeholder="Cari berita..." 
            ...
            <button class="btn-custom text-black font-semibold px-8 py-3 rounded-lg text-sm whitespace-nowrap flex items-center gap-2" id="searchBtn" data-i18n="berita.searchBtn">
    ...
    <div class="mb-8">
        <div class="flex flex-wrap gap-3 justify-center">
            <button class="category-tab active px-6 py-2 text-sm font-medium rounded-lg transition" data-category="semua" data-i18n="berita.tab.all">
                Semua
            </button>
            <button class="category-tab px-6 py-2 text-sm font-medium rounded-lg transition" data-category="siaran-pers" data-i18n="berita.tab.siaranPers">
                Siaran Pers
            </button>
            <button class="category-tab px-6 py-2 text-sm font-medium rounded-lg transition" data-category="nasional" data-i18n="berita.tab.nasional">
                Nasional
            </button>
            <button class="category-tab px-6 py-2 text-sm font-medium rounded-lg transition" data-category="internasional" data-i18n="berita.tab.internasional">
                Internasional
            </button>
        </div>
    </div>
    ...
    <!-- News Grid -->
    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8" id="beritaGrid">
        <!-- News Card 1 -->
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const translations = {
            id: {
                ...
                'berita.title': 'Berita',
                'berita.subtitle': 'Berita Terkini',
                'berita.searchPlaceholder': 'Cari berita...',
                'berita.searchBtn': 'Cari',
                'berita.tab.all': 'Semua',
                'berita.tab.siaranPers': 'Siaran Pers',
                'berita.tab.nasional': 'Nasional',
                'berita.tab.internasional': 'Internasional',
                'berita.category.siaranPers': 'Siaran Pers',
                'berita.readMore': 'Baca Selengkapnya →'
            },
            en: {
                'nav.home': 'Home',
                'nav.profile': 'Profile',
                ...
                'footer.platform': 'Platform',
                'berita.title': 'News',
                'berita.subtitle': 'Latest News',
                'berita.searchPlaceholder': 'Search news...',
                'berita.searchBtn': 'Search',
                'berita.tab.all': 'All',
                'berita.tab.siaranPers': 'Press Release',
                'berita.tab.nasional': 'National',
                'berita.tab.internasional': 'International',
                'berita.category.siaranPers': 'Press Release',
                'berita.readMore': 'Read More →'
            }
        };
        ...
        function applyLanguage(lang) {
            ...
            document.title = lang === 'id' 
                ? 'Berita - Kementerian Haji dan Umrah Kota Cirebon'
                : 'News - Ministry of Hajj and Umrah Cirebon City';
        }

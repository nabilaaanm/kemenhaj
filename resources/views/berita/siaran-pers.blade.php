...
<head>
    ...
    <title>Siaran Pers - Kementerian Haji dan Umrah Kota Cirebon</title>
...
<main class="container-fixed py-12 w-full" style="width: 100%; max-width: 100%; box-sizing: border-box;">
    ...
    <div class="text-center mb-8">
        <h1 class="text-4xl md:text-5xl font-bold mb-4" style="color: #8B6914;" data-i18n="siaranPers.title">
            Siaran Pers
        </h1>
        <p class="text-lg text-gray-600 max-w-3xl mx-auto" data-i18n="siaranPers.subtitle">
            Siaran Pers Resmi Kementerian Haji dan Umrah
        </p>
    </div>
    ...
    <div class="mb-8">
        <div class="flex flex-col md:flex-row gap-4 items-center justify-center max-w-3xl mx-auto">
            <div class="flex-1 w-full relative">
                <input type="text" id="siaranPersSearch" data-i18n-placeholder="siaranPers.searchPlaceholder" placeholder="Cari siaran pers..." 
            ...
            <button class="btn-custom text-black font-semibold px-8 py-3 rounded-lg text-sm whitespace-nowrap flex items-center gap-2" id="searchBtn" data-i18n="siaranPers.searchBtn">
    ...
    <div class="mb-8">
        <div class="flex flex-wrap gap-3 justify-center">
            <button class="category-tab active px-6 py-2 text-sm font-medium rounded-lg transition" data-category="semua" data-i18n="siaranPers.tab.all">
                Semua
            </button>
            <button class="category-tab px-6 py-2 text-sm font-medium rounded-lg transition" data-category="layanan" data-i18n="siaranPers.tab.layanan">
                Layanan
            </button>
            <button class="category-tab px-6 py-2 text-sm font-medium rounded-lg transition" data-category="kerjasama" data-i18n="siaranPers.tab.kerjasama">
                Kerjasama
            </button>
            <button class="category-tab px-6 py-2 text-sm font-medium rounded-lg transition" data-category="kebijakan" data-i18n="siaranPers.tab.kebijakan">
                Kebijakan
            </button>
        </div>
    </div>
    ...
    <!-- News Grid -->
    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8" id="siaranPersGrid">
        <!-- News Card 1 -->
        <article class="siaran-pers-card bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-md transition" data-category="layanan">
            ...
            <div class="p-5">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <a href="#" class="text-sm font-medium hover:underline" style="color: #ECB176;" data-i18n="siaranPers.readMore">
                        Baca Selengkapnya →
                    </a>
                </div>
            </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        categoryTabs.forEach(tab => {
            tab.addEventListener('click', function() {
                ...
                // Filter cards
                const siaranPersCards = document.querySelectorAll('.siaran-pers-card');
                siaranPersCards.forEach(card => {
        ...
        const searchInput = document.getElementById('siaranPersSearch');
        ...
        const translations = {
            id: {
                ...
                'siaranPers.title': 'Siaran Pers',
                'siaranPers.subtitle': 'Siaran Pers Resmi Kementerian Haji dan Umrah',
                'siaranPers.searchPlaceholder': 'Cari siaran pers...',
                'siaranPers.searchBtn': 'Cari',
                'siaranPers.tab.all': 'Semua',
                'siaranPers.tab.layanan': 'Layanan',
                'siaranPers.tab.kerjasama': 'Kerjasama',
                'siaranPers.tab.kebijakan': 'Kebijakan',
                'siaranPers.readMore': 'Baca Selengkapnya →'
            },
            en: {
                'nav.home': 'Home',
                'nav.profile': 'Profile',
                ...
                'footer.platform': 'Platform',
                'siaranPers.title': 'Press Release',
                'siaranPers.subtitle': 'Official Press Releases from Ministry of Hajj and Umrah',
                'siaranPers.searchPlaceholder': 'Search press release...',
                'siaranPers.searchBtn': 'Search',
                'siaranPers.tab.all': 'All',
                'siaranPers.tab.layanan': 'Services',
                'siaranPers.tab.kerjasama': 'Cooperation',
                'siaranPers.tab.kebijakan': 'Policy',
                'siaranPers.readMore': 'Read More →'
            }
        };
        ...
        function applyLanguage(lang) {
            ...
            document.title = lang === 'id' 
                ? 'Siaran Pers - Kementerian Haji dan Umrah Kota Cirebon'
                : 'Press Release - Ministry of Hajj and Umrah Cirebon City';
        }

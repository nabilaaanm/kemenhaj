        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
            ...
            <div>
                ...
                <div class="flex gap-3">
                    <a href="#" class="w-8 h-8 bg-black rounded-full transition" style="display: flex; align-items: center; justify-content: center; line-height: 0;">
            ...
            <div>
                ...
                <p class="footer-muted text-sm mb-2">
                    <span class="font-medium">Telp:</span> +62 895-0706-9859<br>
                </p>
                <p class="footer-muted text-sm">
                    <span class="font-medium">Email:</span><br>
                    cirebonkota@haji.go.id
                </p>
            </div>

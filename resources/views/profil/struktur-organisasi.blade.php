...
<head>
    ...
    <title>Struktur Organisasi - {{ $siteSetting->title_suffix }}</title>
...
<main class="container-fixed py-12 w-full" style="width: 100%; max-width: 100%; box-sizing: border-box;">
    ...
    <div class="mb-12 text-center">
        <h1 class="text-4xl md:text-5xl font-bold mb-4 page-title" style="color: #374151;" data-i18n="structure.title">
            Struktur Organisasi
        </h1>
